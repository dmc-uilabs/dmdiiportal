...
public class NewTaskFromProjectTest {
  ...
  public void testNewTaskFromProject() throws Exception {
    ...
    driver.findElement(By.id("input_6")).sendKeys("testing task from projects page for selenium");
    driver.findElement(By.id("input_7")).clear();
    driver.findElement(By.id("input_7")).sendKeys("selenium test");
