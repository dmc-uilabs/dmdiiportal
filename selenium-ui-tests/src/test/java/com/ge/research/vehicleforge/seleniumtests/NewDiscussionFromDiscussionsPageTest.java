...
public class NewDiscussionFromDiscussionsPageTest {
  ...
  public void testNewDiscussion() throws Exception {
    ...
    driver.findElement(By.id("subject-compose-discussion")).sendKeys("Adding a test for selenium");
    driver.findElement(By.id("input_9")).clear();
    driver.findElement(By.id("input_9")).sendKeys("This is a new discussion for testing in selenium");
    driver.findElement(By.id("input_10")).clear();
    driver.findElement(By.id("input_10")).sendKeys("Test for selenium");
    ...
    driver.findElement(By.id("input_3")).sendKeys("this tests the comment reply feature");
    // ERROR: Caught exception [Error: Dom locators are not implemented yet!]
    driver.findElement(By.xpath("//div[3]/button[2]")).click();
    driver.findElement(By.id("input_2")).clear();
    driver.findElement(By.id("input_2")).sendKeys("this tests the new comment feature");
    // ERROR: Caught exception [Error: Dom locators are not implemented yet!]
  }
