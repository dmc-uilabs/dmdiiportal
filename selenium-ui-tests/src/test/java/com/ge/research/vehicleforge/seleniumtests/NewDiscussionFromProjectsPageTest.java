...
public class NewDiscussionFromProjectsPageTest extends BaseTest {
	 ...
	 * @Ignore
	 * 
	 * @Test public void testCreateNewDiscussionFromProjectsPage() throws
	 * Exception{ createNewDiscussionFromProjectsPage(); }
	 */
	...
	public void createNewDiscussionFromProjectsPage(String projectsPage) throws Exception {
		...
		String table = driver
				.findElement(By.xpath("/html/body/div[2]/ui-view/div[2]/div/div[1]/div[2]/div[2]/md-content"))
				.getText();
