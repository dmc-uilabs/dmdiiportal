...
public class NewDiscussionFromProjectsPageTest {
  ...
  public void testNewDiscussionFromProjectsPage() throws Exception {
    ...
    driver.findElement(By.id("subject-compose-discussion")).sendKeys("Testing new discussion from project page");
    driver.findElement(By.id("input_11")).clear();
    driver.findElement(By.id("input_11")).sendKeys("This is for selenium");
    driver.findElement(By.id("input_12")).clear();
    driver.findElement(By.id("input_12")).sendKeys("selenium");
