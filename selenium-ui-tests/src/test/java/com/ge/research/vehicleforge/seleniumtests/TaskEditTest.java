...
public class TaskEditTest {
  ...
  public void testTaskEdit() throws Exception {
    ...
    driver.findElement(By.id("input_6")).sendKeys("test task edit");
    driver.findElement(By.id("input_7")).clear();
    driver.findElement(By.id("input_7")).sendKeys("for selenium");
    ...
    driver.findElement(By.id("input_16")).sendKeys("this is a selenium test");
    driver.findElement(By.id("input_15")).clear();
    driver.findElement(By.id("input_15")).sendKeys("task has been edited for selenium");
    driver.findElement(By.xpath("(//button[@type='button'])[8]")).click();
