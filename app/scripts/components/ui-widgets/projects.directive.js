...
angular.module('dmc.widgets.projects',[
    ...
    .directive('uiWidgetProjects', ['$parse', function ($parse) {
        ...
        function UiWidgetProjectsController($scope, $rootScope, $element, $attrs, socketFactory, dataFactory, ajax, toastModel, DMCUserModel, $showdown) {
                var vm = this;
...
vm.currentPage = 0;
            ...
            $scope.$watch(function () { return vm.getProjectsFlag; }, function(newValue, oldValue) {
                ...
                vm.getProjects = function(){
                    ...
                    console.log(response.data);    var ids = [];
