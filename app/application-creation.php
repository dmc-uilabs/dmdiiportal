...
<body ng-app="dmc.application-creation">
    <!--[if lt IE 10]>
    ...
    <script src="scripts/application-creation/application-creation.js"></script>
    <script src="scripts/application-creation/application-creation-controller.js"></script>
    <!-- endbuild -->
