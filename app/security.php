...
<body ng-app="dmc.security">
    ...
    <!-- build:js scripts/security/index.js -->
    ...
    <script src="scripts/security/security.js"></script>
    <script src="scripts/security/security-controller.js"></script>
    <!-- endbuild -->
